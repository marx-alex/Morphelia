...
def run(inp,
    ...
    adata = pseudostitch(adata, tile_grid=tile_grid, img_overlap=img_overlap, verbose=True)
...
def main(args=None):
    ...
    parser = argparse.ArgumentParser(description=f'Pseudostitching.')

    parser.add_argument('-i', '--inp', type=str,
                        help='Input AnnData object.')
    parser.add_argument('-o', '--out', type=str, default="./",
                        help="Where to store the stitched AnnData object.")
    parser.add_argument('--tile_grid', nargs='+', default=[5, 5],
                        help="Grid dimensions of fields in a single well.")
    parser.add_argument('--img_overlap', type=float, default=0.2,
